...
if __name__ == "__main__":
    ...
    if args.kps == 'MigrationNet':
        ...
        ckpt_dir = '../output/ckpt/MIT_checkpoint_epoch_46.pth'#VIFT_MIT_withoutRegularDecorr.pth/MIT_checkpoint_epoch_46.pth
        ...
        ckpt_dir = '../output/ckpt/checkpoint_epoch_scale.pth' # ablation: VIFT_MIT_withoutusp.pth, VIFT_MIT_withoutRegularDecorr.pth, silk (without decorr)
        model = get_sym(model_config=cfg['MODEL'], image_shape=cfg['MIT_data']['IMAGE_SHAPE'])
        model.load_state_dict(torch.load(ckpt_dir, map_location=device)['model_state'])
        # model.load_params_from_file(filename=ckpt_dir, logger=logger, to_cpu=dist_test)
        model.cuda()
    ...
    if args.des == 'Silk':
        ...
        ckpt_dir = '../output/ckpt/MIT_checkpoint_epoch_46.pth'  # VIFT_MIT_withoutRegularDecorr.pth, MIT_checkpoint_epoch_46.pth, VIFT_MIT_withoutusp.pth
