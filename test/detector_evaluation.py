...
eval_root_path = '../Unsuper/output/eval/eval_all/epoch_15/HPatch'  # epoch_2/HPatch/
...
if __name__ == '__main__':
    ...
    for i in range(start_epoch, end_epoch + 1):
        ...
        eval_out = eval_root_path #eval_root_path + ('epoch_%d') + '/HPatch/'
        ...
        repeatability, loc_error, sim = compute_repeatability(eval_out=eval_out, eval_data=eval_data, keep_k_points=eval_topk, distance_thresh=eval_dis, verbose=False)
