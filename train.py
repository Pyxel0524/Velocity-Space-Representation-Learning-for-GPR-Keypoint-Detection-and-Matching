...
def parse_config():
    ...
    parser.add_argument('--dataset', type=str, default='CMU_data', help='dataset_name. MIT_data, CMU_data')
...
def main():
    ...
    if args.launcher == 'none':
        dist_train = False
        args.batch_size = cfg[args.dataset]['batch_size']
    else:
        dist_train = True
        args.batch_size = cfg[args.dataset]['batch_size']
    ...
    model = get_sym(model_config=cfg['MODEL'], image_shape=cfg[args.dataset]['IMAGE_SHAPE'])
    if args.sync_bn:
